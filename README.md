...
Live Availability: Workers can turn their status ON (Available) or OFF (Busy). This means employers only call people who are actually free, saving everyone’s time.

Smart Voice Assistant: We used Gemini 1.5 Flash to create a voice assistant. This is perfect for workers who find typing difficult—they can just talk to the app to register or find a job.
